...
def build_tool_preview(tool_name: str, args: dict, max_len: int | None = None) -> str | None:
    ...
    *max_len* controls truncation.  ``None`` (default) defers to the global
    ...
    primary_args = {
        ...
        "browser_snapshot": "full", "browser_console": "expression",
        "browser_press": "key", "browser_scroll": "direction",
    ...
    if tool_name == "browser_snapshot":
        return "full" if args.get("full") else "compact"

    if tool_name == "browser_console" and not args.get("expression"):
        return "console logs"
