...
class _ManagedRotatingFileHandler(RotatingFileHandler):
    ...
    def doRollover(self):
        try:
            ...
            # Windows can keep the active log locked briefly when CLI and
            # gateway processes write at the same time. Keep logging to the
            # current file and retry rotation later instead of printing a
            # noisy "Logging error" traceback to the user-facing command.
