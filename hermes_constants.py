...
def _safe_home() -> Path:
    """Return the OS home directory, or a local fallback when unavailable."""
    try:
        return Path.home()
    except RuntimeError:
        return Path.cwd()
...
def get_hermes_home() -> Path:
    ...
    if not _profile_fallback_warned:
        try:
            ...
            active_path = (_safe_home() / ".hermes" / "active_profile")
