...
def _cleanup_single_browser_session(task_id: str) -> None:
    ...
    if session_info:
        ...
        # Config/env CDP sessions attach to a browser the user owns. Closing the
        # browser here makes the next command fail with a stale CDP endpoint.
        if not session_info.get("cdp_url") or session_info.get("bb_session_id"):
            try:
