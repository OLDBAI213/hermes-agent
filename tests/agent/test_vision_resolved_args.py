...
def test_task_provider_model_keeps_provider_with_base_url():
    """Provider-scoped base_url must not be reclassified as custom."""
    ...
    assert base_url == "https://token-plan-sgp.xiaomimimo.com/v1"
