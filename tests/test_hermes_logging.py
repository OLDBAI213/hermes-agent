...
class TestAddRotatingHandler:
    ...
    @pytest.mark.skipif(os.name == "nt", reason="Windows chmod does not support POSIX group-writable mode bits")
    ...
    def test_rollover_permission_error_is_suppressed_temporarily(self, tmp_path):
        ...
        assert "first message" in log_path.read_text()
